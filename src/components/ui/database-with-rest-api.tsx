    ...
    >
      ...
      <div className="absolute bottom-10 md:bottom-16 flex w-full flex-col items-center px-4">
        ...
        <div className="relative z-10 flex h-[200px] md:h-[280px] lg:h-[320px] w-full items-center justify-center overflow-hidden rounded-xl border bg-background shadow-md">
          ...
          {/* Circles */}
          <motion.div
            className="absolute -bottom-16 md:-bottom-20 h-[120px] md:h-[160px] w-[120px] md:w-[160px] rounded-full border-t border-primary/20 bg-accent/5"
            animate={{
          ...
          />
          <motion.div
            className="absolute -bottom-24 md:-bottom-32 h-[180px] md:h-[240px] w-[180px] md:w-[240px] rounded-full border-t border-primary/15 bg-accent/5"
            animate={{
          ...
          />
          <motion.div
            className="absolute -bottom-[130px] md:-bottom-[180px] h-[250px] md:h-[340px] w-[250px] md:w-[340px] rounded-full border-t border-primary/10 bg-accent/5"
            animate={{
          ...
          />
          <motion.div
            className="absolute -bottom-[160px] md:-bottom-[220px] h-[320px] md:h-[440px] w-[320px] md:w-[440px] rounded-full border-t border-primary/5 bg-accent/5"
            animate={{
