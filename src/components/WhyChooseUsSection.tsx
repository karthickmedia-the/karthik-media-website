...
const WhyChooseUsSection = () => {
  return <section className="py-20 md:py-32 bg-black w-full relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0 pointer-events-none">
        <motion.div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#C8F200]/5 rounded-full blur-3xl" animate={{
        scale: [1, 1.1, 1],
        opacity: [0.3, 0.5, 0.3]
      }} transition={{
        duration: 10,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          once: true
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <motion.a href="https://topmate.io/karthik_media/1790830" target="_blank" rel="noopener noreferrer" whileHover={{
              scale: 1.02
            }} whileTap={{
              scale: 0.98
              ...
              scale: 0.98
                ...
                <Link to="/case-studies" className="inline-flex items-center justify-center px-6 py-3 border border-zinc-700 text-white font-semibold rounded-lg transition-all hover:border-[#C8F200]/50 hover:text-[#C8F200]">
                  View Case Studies
                </Link>
              </motion.div>
            </div>
