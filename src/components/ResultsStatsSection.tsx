...
const AnimatedCounter = ({ value, suffix }: { value: number; suffix: string }) => {
  ...
  return (
    <motion.span
      ...
      className="text-5xl md:text-7xl font-bold text-[#C8F200]"
    >
      {displayValue}{suffix}
    </motion.span>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 backdrop-blur-sm border border-zinc-800/50 rounded-2xl p-6 md:p-8 text-center transition-all duration-500 hover:border-[#C8F200]/40 hover:shadow-[0_0_30px_rgba(200,242,0,0.1)]">
