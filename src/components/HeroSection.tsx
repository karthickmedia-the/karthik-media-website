  ...
  return (
    <section className="relative min-h-screen bg-background overflow-hidden flex flex-col">
      ...
      <div className="container mx-auto px-4 pt-20 pb-12 relative z-10 text-center">
        ...
        <div className="absolute bottom-32 right-4 md:right-12 lg:right-24 bg-background/95 backdrop-blur-sm p-6 rounded-2xl max-w-sm border-2 border-primary/20 z-30">
