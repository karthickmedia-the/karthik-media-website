      ...
      <div className="container mx-auto px-4 py-12 relative">
        ...
        <div className="relative flex justify-center items-center min-h-[800px] md:min-h-[1000px]">
          ...
          <div className="relative flex justify-center items-center w-full">
            ...
            height: 'auto',
            minHeight: '800px'
          }} src="/lovable-uploads/6e6d3707-0b3f-44c3-b552-50c2748432fa.png" className="relative z-50 w-[800px] md:w-[1200px] lg:w-[1600px] object-contain border-slate-50 border" />
          </div>
        </div>
