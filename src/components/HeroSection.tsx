    ...
    <section className="relative min-h-screen bg-background overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-20 pb-32 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right Content - Person with circular background */}
          <div className="relative flex justify-center items-end">
            {/* Yellow circular background */}
            <div className="absolute bottom-0 w-[500px] h-[500px] bg-primary rounded-full -mb-32"></div>
            ...
            {/* CTA Buttons */}
            <div className="absolute bottom-16 left-1/2 -translate-x-1/2 flex flex-col sm:flex-row gap-4 z-20 w-full max-w-2xl px-4">
              <Button 
            ...
            {/* Testimonial Card */}
            <div className="absolute top-0 right-0 bg-background/95 backdrop-blur-sm p-6 rounded-2xl max-w-sm border-2 border-primary/20">
